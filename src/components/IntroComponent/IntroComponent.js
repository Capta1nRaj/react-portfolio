      ...
      <section className="intro-component-section" style={{ backgroundImage: `url(${props.backgroundImage})` }}>
        <div className="max-width">
          <div className="my-intro-text-container" style={{ fontFamily: props.IntroComponentFontFamily }}>
            ...
            <div className="line-2">My Name Is <span style={{ color: "red" }}>Priyal Raj</span></div>
            <div className="line-3">I'M A <span style={{ color: "red" }}><Typed strings={props.profession} typeSpeed={60} backSpeed={60} backDelay={2000} loop={true} /></span></div>
